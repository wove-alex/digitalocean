...
<a class="col-12 main-link" href="<?php the_permalink(); ?>">
    
    <?php if(has_post_thumbnail()) { ?> 
    <img class="object-cover people-img rounded img-fluid" src="<?php $coastWork_id = get_post_thumbnail_id(); $coastWork_url = wp_get_attachment_image_src($coastWork_id,"medium", true); echo $coastWork_url[0]; ?>">
    <?php } else { ?>
        <span class="object-cover rounded people-img grey"></span>
    <?php } ?>
    <p class="mt-0 mb-0"><?php the_title(); ?><br>
